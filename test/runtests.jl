...
@timev begin
  @testset "All Tests" begin
    @safetestset "Classical Rewriting" begin
      include("test_reductions.jl")
    end
    @safetestset "EGraphs Basics" begin
      include("test_egraphs.jl")
    end
    @safetestset "EMatch" begin
      include("test_ematch.jl")
    end
    @safetestset "EGraph Analysis" begin
      include("test_analysis.jl")
    end
    @safetestset "EGraph Extraction" begin
      include("test_extraction.jl")
    end
    @safetestset "Mu Puzzle" begin
      include("test_mu.jl")
    end
    @safetestset "While Interpreter" begin
      include("test_while_interpreter.jl")
    end
    @safetestset "Taylor Series" begin
      include("test_taylor.jl")
    end
    @safetestset "While Superinterpreter" begin
      include("test_while_superinterpreter.jl")
    end
    @safetestset "EGraphs Inequalities" begin
      include("test_inequality.jl")
    end
    @safetestset "Custom Types" begin
      include("test_custom_types.jl")
    end
    @safetestset "Fibonacci" begin
      include("fib/test_fibonacci.jl")
    end
    @safetestset "Calculational Logic" begin
      include("logic/test_calculational_logic.jl")
    end
    @safetestset "PROP Logic" begin
      include("logic/test_logic.jl")
    end
    @safetestset "CAS Infer" begin
      include("cas/test_infer.jl")
    end
    @safetestset "Knuth Bendix Alternative Hurwitz Groups" begin
      include("test_kb_benchmark.jl")
    end
    @safetestset "Stream Fusion" begin
      include("test_stream_fusion.jl")
    end
